...
interface D3jsShowcaseProps {
  onClose: () => void;
}

export default function D3jsShowcase({ onClose }: D3jsShowcaseProps) {
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 text-white p-4 sm:p-6 font-sans overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 text-lg mb-8">Aquí se mostrarán los proyectos y ejemplos de D3.js.</p>
        {/* Contenido específico de D3.js */}
        <div className="bg-gray-800/50 rounded-lg p-6 backdrop-blur-sm border border-gray-700/50">
          ...
          <p className="text-gray-400">Esta sección está en desarrollo. Vuelve pronto para ver mis visualizaciones personalizadas con D3.js.</p>
        </div>
      </div>
    </div>
  );
