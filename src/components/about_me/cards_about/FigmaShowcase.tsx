...
export default function FigmaShowcase({ onClose }: FigmaShowcaseProps) {
  return (
    <div className="w-full h-full bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-900 text-white p-4 sm:p-6 font-sans overflow-y-auto">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-gray-300 text-lg mb-8">Aquí se mostrarán los proyectos y ejemplos de Figma.</p>
        {/* Contenido específico de Figma */}
        <div className="bg-gray-800/50 rounded-lg p-6 backdrop-blur-sm border border-gray-700/50">
          ...
          <p className="text-gray-400">Esta sección está en desarrollo. Vuelve pronto para ver mis diseños y prototipos en Figma.</p>
        </div>
      </div>
    </div>
  );
